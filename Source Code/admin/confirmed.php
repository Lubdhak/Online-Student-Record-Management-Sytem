	...
	<div id="adwrapper">
		...
		<div id="adcontent">
			<div class="tables">
				<table align="center">
					<br/>
					<th><h2>Confirmed for physics</h2></th>
					<tr>
						<td>
							<table>
								<tr><td>
								...
								<?php
									$sqlphy="SELECT users_name, users_email, users_tmarks, phy_s FROM users WHERE phy_s='2' ORDER BY users_tmarks DESC LIMIT 100";
			...
			<div class="tableps">
				<table align="center">
					<br/>
					<th><h2>Confirmed for Chemistry</h2></th>
					<tr>
						<td>
							<table>
								<tr><td>
								<table><th>Name<hr/></th> <th>Email<hr/></th> <th>Marks<hr/></th>
								<?php
									$sqlchem="SELECT users_name, users_email, users_tmarks, chem_s FROM users WHERE chem_s='2' ORDER BY users_tmarks DESC LIMIT 100";
			...
			<div class="tables">
				<table align="center">
					<br/>
					<th><h2>Confirmed for Biology</h2></th>
					<tr>
						<td>
							<table>
								<tr><td>
								<table><th>Name<hr/></th> <th>Email<hr/></th> <th>Marks<hr/></th>
								<?php
									$sqlbio="SELECT users_name, users_email, users_tmarks, bio_s FROM users WHERE bio_s='2' ORDER BY users_tmarks DESC LIMIT 100";
			...
			<div class="tableps">
				<table align="center">
					<br/>
					<th><h2>Confirmed for Math</h2></th>
					<tr>
						<td>
							<table>
								<tr><td>
								<table><th>Name<hr/></th> <th>Email<hr/></th> <th>Marks<hr/></th>
								<?php
									$sqlmath="SELECT users_name, users_email, users_tmarks, math_s FROM users WHERE math_s='2' ORDER BY users_tmarks DESC LIMIT 100";
									$resultmath=mysql_query($sqlmath) or die(mysql_error());
			...
			<div class="tables">
				<table align="center">
					<br/>
					<th><h2>Confirmed for Computer Sceince</h2></th>
					<tr>
						<td>
							<table>
								<tr><td>
								<table><th>Name<hr/></th> <th>Email<hr/></th> <th>Marks<hr/></th>
								<?php
									$sqlcom="SELECT users_name, users_email, users_tmarks, com_s FROM users WHERE com_s='2' ORDER BY users_tmarks DESC LIMIT 100";
